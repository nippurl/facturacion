...
<?= $generator->generateRouteForControllerMethod('/nuevo', sprintf('%s_new', $route_name), ['GET', 'POST']) ?>
...
<?= $generator->generateRouteForControllerMethod(sprintf('/ver/{%s}', $entity_identifier), sprintf('%s_show', $route_name), ['GET']) ?>
...
<?= $generator->generateRouteForControllerMethod(sprintf('/{%s}/editar', $entity_identifier), sprintf('%s_edit', $route_name), ['GET', 'POST']) ?>
...
<?= $generator->generateRouteForControllerMethod(sprintf('/{%s}/borrar', $entity_identifier), sprintf('%s_delete', $route_name), ['POST']) ?>
